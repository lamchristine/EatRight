...
function FoodService($http, $q) {
  ...
  function query(searchTerm) {
    ...
    var url = "https://api.nutritionix.com/v1_1/search/" + searchTerm + "?results=0:20&fields=item_name,brand_name,item_id,nf_calories,nf_total_fat&appId=285dc9c7&appKey=ecd9dbdbeb3528353f71335e422e8653";
    console.log('url = ', url);
